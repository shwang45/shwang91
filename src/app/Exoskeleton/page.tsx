    ...
    <div>
      ...
      >
        <Typography variant="h4" component={"h4"}>
          Development of Wearable Robot System for Gait Rehabilitation
        </Typography>
        <div style={{ fontSize: '24px' }}>Objective</div>
        <div style={{ fontSize: '13px', textAlign: "justify" }}><b>Wearable robots</b> are one of the most promising technologies for rehabilitation and assistance of human movements. 
        In this study, We developed a <b>lower-extremity wearable robot for the gait rehabilitation</b> of neurological patients, especially <b>stroke and spinal cord injury patients.</b> Stroke patients with hemiplegia exhibit different gait characteristics between the affected and healthy sides of their limbs. 
