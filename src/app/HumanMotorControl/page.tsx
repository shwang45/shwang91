  ...
  return (
    <div>
      ...
      >
        ...
        and <b>males showed higher stiffness at all arom postures compared to females (figure D-F).</b> These results can explain how intrinsic mechanical properties of human shoulder joint can be affected to joint stability in 3D space, 
        and also provide the explaination why females have more incidence of shoulder joint injury than males.</div>
        <div style={{ flex: 1, display: "flex", justifyContent: "center" }}>
            <img 
        ...
        <div style={{ fontSize: '24px' }}>Publications</div>
          ...
          [1] Hwang, Seunghoon, et al. "Characterization of Human Shoulder Joint Stiffness across 3D Arm Postures and its Sex Differences." IEEE Transactions on Biomedical Engineering (2024).
          </a>
          <a href="https://drive.google.com/file/d/1yzsv_eGGGYabFcbmiv777iLPryVbN9fl/view?usp=share_link">
          [2] Seunghoon Hwang, Edward Chan, and Hyunglae Lee. "Quantification of Shoulder Joint Impedance during Dynamic Motion: A Pilot Study Using a Parallel-Actuated Shoulder Exoskeleton Robot" IEEE Ubiquitous obot (2024).
          </a>
      </div>
    </div>
  );
